...
export const PlinkoEngine = memo(forwardRef<PlinkoEngineRunner, PlinkoEngineProps>(({ onResult, ...props }, ref) => {
    ...
    const multipliers = [50000000000000000000000000000000.0, 1300000000000000000000000000.0, 260000000000000000000000000.0, 90000000000000000000000000.0, 40000000000000000000000000.0, 20000000000000000000000000.0, 2000000000000000000000000000000.0, 2000000000000000000000000000000.0, 2000000000000000000000000000000.0, 20000000000000000000000000000000.0, 40000000000000000000000000000000.0, 90000000000000000000000000.0, 26000000000000000000000000.0, 1300000000000000000000000000.0, 50000000000000000000000000000000.0];
